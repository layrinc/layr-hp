...
const WORKSPACE_ASSETS = Object.freeze({'/': `${MANAGER_PATH}overview/`, '/regional/': MANAGER_PATH, '/media/': MEDIA_MANAGER_PATH, '/growth/': `${MANAGER_PATH}growth/`, '/articles/': `${MANAGER_PATH}articles/`, '/strategy/': `${MANAGER_PATH}strategy/`, '/backlinks/': `${MANAGER_PATH}backlinks/`, '/regulation/': `${MANAGER_PATH}regulation/`, '/outreach/': `${MANAGER_PATH}outreach/`});
