...
export default defineConfig({
  ...
  integrations: [
    sitemap({
      ...
      filter: (page) =>
        !page.includes('/dashboard') && !page.includes('/admin') && !page.includes('/document/thanks') && !page.includes('/partner') && !page.includes('/tools/ltori-seo') && !page.includes('/service/ltori/article-template'),
    }),
  ],
});
