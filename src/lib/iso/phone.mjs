...
export default `<svg viewBox="0 0 420 420" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="アイソメトリックの台座に立つスマートフォンとLINEトーク画面・リッチメニューのイラスト">
  ...
  <!-- ===== 台座 下端のティール帯 ===== -->
  <path d="M77 293 Q58 304 77 315 L191 381 Q210 392 229 381 L343 315 Q362 304 343 293 L343 298 Q362 309 343 320 L229 386 Q210 397 191 386 L77 320 Q58 309 77 298 Z" fill="#0F9E96"/>
  ...
  <g transform="matrix(0.866,-0.5,0,1,150,105)">
    ...
    <!-- --- ヘッダーバー --- -->
    <rect x="7" y="9" width="90" height="21" rx="4" fill="#0F9E96"/>
    <rect x="7" y="24" width="90" height="6" fill="#0F9E96"/>
    <circle cx="20" cy="19.5" r="7.5" fill="#FFFFFF"/>
    <circle cx="20" cy="19.5" r="4" fill="#3FBDB4"/>
    <rect x="32" y="14.6" width="34" height="4" rx="2" fill="#3FBDB4"/>
    <rect x="32" y="21.6" width="22" height="3" rx="1.5" fill="#3FBDB4"/>
    ...
    <rect x="37.7" y="148" width="27.3" height="24.5" rx="2" fill="#0F9E96"/>
