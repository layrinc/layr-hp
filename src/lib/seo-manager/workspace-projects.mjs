...
export const WORKSPACE_PROJECTS = Object.freeze([
  {id: 'regional', name: 'エルトリ全国SEO', shortName: '全国SEO', href: '/regional/', prefix: '/service/ltori/area/', publicUrl: 'https://layr.co.jp/service/ltori/area/', description: '地域の採用事情を調べ、市町村のページと検索実績を管理します。'},
